...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ib_brush: ImageButton = findViewById(R.id.ibBrush)
        ...
        val ibGallery: ImageButton = findViewById(R.id.ibImage)
    ...
    fun paintClicked(view: View) {
        if (view !== mImageButtonCurrentPaint) {
            ...
            // definir o botão atual em que clicamos para ser pressionado
            imageButton.setImageDrawable(
                ContextCompat.getDrawable(this, R.drawable.pallet_pressed)
            )
            // desativando o botão antigo que tínhamos pressionado
            mImageButtonCurrentPaint?.setImageDrawable(
                ContextCompat.getDrawable(this, R.drawable.pallet_normal)
            )
            // certificando que essa propriedade que apenas manterá o botão atual
